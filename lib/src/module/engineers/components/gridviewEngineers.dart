...
class _GridViewScreenEnginnersState extends State<GridViewScreenEnginners> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return logic.filteredEngineer.value.isEmpty? GridView.builder(
        // shrinkWrap: true,
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              onTap: () {
                Get.to(() =>
                EngineerDetails(ID: logic.albumsList.value[index]['id'], avatar: logic.albumsList.value[index]['avatar_url'], name: logic.albumsList.value[index]['name'], email: logic.albumsList.value[index]['email'], slug: logic.albumsList.value[index]['slug'],));
                // Navigator.push(
                //     context,
                //     MaterialPageRoute(
                //         builder: (context) =>
        ...
        // shrinkWrap: true,
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              onTap: () {
                Get.to(() =>
                    EngineerDetails(ID: logic.filteredEngineer.value[index]['id'], avatar: logic.albumsList.value[index]['avatar_url'], name: logic.albumsList.value[index]['name'], email: logic.albumsList.value[index]['email'], slug: logic.albumsList.value[index]['slug'],));
                // Navigator.push(
                //     context,
                //     MaterialPageRoute(
                //         builder: (context) =>
                  ...
                  Expanded(
                    ...
                    child: ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        width: 150,
                        child: CachedNetworkImage(
                          imageUrl: logic.filteredEngineer.value[index]['avatar_url'],
