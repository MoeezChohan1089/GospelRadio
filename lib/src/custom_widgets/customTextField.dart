    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        contentPadding: EdgeInsets.only(
            left: contentPaddingLeft ?? 10,
            right: contentPaddingRight ?? 10,
            top: contentPaddingTop ?? 10,
            bottom: contentPaddingBottom ?? 10),
        isDense: true,
        hintText: hintText ?? "",
        hintStyle: context.text.bodyMedium?.copyWith(
            fontSize: 14.5.sp, color: AppColors.customGreyBorderColor),
        label: hintText == null
            ? CustomText(
                title: labelText ?? "",
        ...
        border: isUnderlineInputBorder == false && isOutlineInputBorder == false
            ...
            : isOutlineInputBorder == false
                ? UnderlineInputBorder(
                    borderSide: BorderSide(width: 1, color: Color(0xffF2F2F2)))
                : OutlineInputBorder(
